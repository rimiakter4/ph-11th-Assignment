        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {steps.map((step) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: step.id * 0.2 }}
              /* ৩. কার্ডের ব্যাকগ্রাউন্ড, বর্ডার ও শ্যাডো ডার্ক মোড অনুযায়ী */
              className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all border border-transparent dark:border-gray-700"
            >
              <div className="text-4xl mb-4">{step.icon}</div>
              
              {/* ৪. টাইটেল ও ডেসক্রিপশন টেক্সট কালার */}
